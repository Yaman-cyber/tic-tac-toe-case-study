...
exports.playerMove = async (req, res, next) => {
  ...
  if (playerMoveResult.response.game_over) {
    ...
    game.result = !playerMoveResult?.response?.winner ? gameResult.DRAW : playerMoveResult?.response?.winner?.toLowerCase() === game.userPlayer ? gameResult.WON : gameResult.LOST;
  }
